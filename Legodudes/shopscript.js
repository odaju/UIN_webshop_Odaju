...
//Lage en funskjon som skriver ut produktene i handlevognen
function printCart() {
    //Starte med en tom variabel som vi kan fulle med HTML
    let cartHTML = ""

    //Lag klar variabel for pris:
    let cartTotal = 0;

    //Lag varabel for antall produkter i handlekurven (rødt ikon)
    let cartNumber = 0;
